 ...
 * @author Harsh
 */
public class DiagnosticTest extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
 ...
 private void Reset()
{
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Dignostic Info", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(51, 51, 51))); // NOI18N
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel1.setText("Diagnostic Test Name");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 41, -1, -1));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 121, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel4.setText("Patient Name");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 161, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel5.setText("Service Charges");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 201, -1, -1));
        jPanel1.add(txtServiceName, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 38, 216, -1));
        ...
        jPanel1.add(txtServiceDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 78, 120, -1));

        jLabel36.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel36.setText("(DD/MM/YYYY)");
        jPanel1.add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(309, 81, -1, -1));

        txtPatientID.setEditable(false);
        jPanel1.add(txtPatientID, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 118, 120, -1));

        txtPatientName.setEditable(false);
        jPanel1.add(txtPatientName, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 158, 216, -1));
        ...
        jPanel1.add(txtServiceCharges, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 198, 119, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(31, 25, 410, 240));

        tblPatient.setBackground(new java.awt.Color(219, 219, 219));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(579, 35, 256, 456));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(467, 35, 90, 150));

        txtServiceID.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txtServiceID, new org.netbeans.lib.awtextra.AbsoluteConstraints(54, 290, 86, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/add new patient background.jpg"))); // NOI18N
        jLabel6.setText("jLabel6");
        jLabel6.setPreferredSize(new java.awt.Dimension(855, 510));
    ...
    private void btnGetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGetDataActionPerformed
     this.hide();
     DiagnosticInfo frm= new DiagnosticInfo();
     frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiagnosticTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new DiagnosticTest().setVisible(true);
            }
        });
    }
