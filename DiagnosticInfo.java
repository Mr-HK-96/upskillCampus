 ...
 * @author Harsh
 */
public class DiagnosticInfo extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      try{
           ...
           String sql=" Select * from PatientRegistration,Services where Services.PatientID=PatientRegistration.PatientID and ServiceID=" + table_click  + "";
            ...
            if(rs.next()){
                this.hide();
                DiagnosticTest frm = new DiagnosticTest();
                frm.setVisible(true);
   ...
   frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiagnosticInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
